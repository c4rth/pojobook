...
import org.c4rth.pojobook.parser.ConditionName;
...
public class ConditionNameTest {
    ...
    @Test
    void testSingleConditionValue() throws IOException {
        String copybook = """
                   01  EMPLOYEE-RECORD.
    ...
    @Test
    void testMultipleConditionValues() throws IOException {
        String copybook = """
    ...
    @Test
    void testConditionWithSpaces() throws IOException {
        String copybook = """
                   01  MENU-RECORD.
    ...
    @Test
    void testRealWorldCopybook() throws IOException {
    ...
    private static CopybookDefinition getCopybookDefinition() throws IOException {
        String copybook = """
    ...
    @Test
    void testConditionNamesNotLinkedToFiller() throws IOException {
        String copybook = """
                   01  TEST-RECORD.
                       05  FILLER              PIC X(2).
