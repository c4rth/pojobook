...
class SignLeadingSeparateTest {
    ...
    private Logger log = LoggerFactory.getLogger(SignLeadingSeparateTest.class);
    ...
    @Test
    void testParseSignLeadingSeparate() throws IOException {
        String copybook = """
                   01  TEST-RECORD.
    ...
    @Test
    void testParseSignTrailingSeparate() throws IOException {
        String copybook = """
                   01  TEST-RECORD.
