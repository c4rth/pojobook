...
public class EncodingSpecialCharactersTest {
    ...
    void testSpecialCharactersDifferentInAsciiAndEbcdic() throws Exception {
        ...
        // Test ASCII encoding
        PojoBook asciiPojoBook = new PojoBook();
        LatinRecord asciiRecord = new LatinRecord();
        asciiRecord.setTextField(testString);

        byte[] asciiData = asciiPojoBook.serialize(asciiRecord, StandardCharsets.ISO_8859_1);

        // Test EBCDIC encoding
        PojoBook ebcdicPojoBook = new PojoBook();
        EbcdicRecord ebcdicRecord = new EbcdicRecord();
        ebcdicRecord.setTextField(testString);

        byte[] ebcdicData = ebcdicPojoBook.serialize(ebcdicRecord, Charset.forName("CP1047"));
        ...
        LatinRecord deserializedAscii = asciiPojoBook.deserialize(asciiData, LatinRecord.class, StandardCharsets.ISO_8859_1);
        assertEquals(testString, deserializedAscii.getTextField().trim());

        EbcdicRecord deserializedEbcdic = ebcdicPojoBook.deserialize(ebcdicData, EbcdicRecord.class, Charset.forName("CP1047"));
    ...
    void testEncodingMismatchCausesDataCorruption() throws Exception {
        ...
        PojoBook asciiPojoBook = new PojoBook();
        LatinRecord asciiRecord = asciiPojoBook.deserialize(ebcdicData, LatinRecord.class, StandardCharsets.ISO_8859_1);
