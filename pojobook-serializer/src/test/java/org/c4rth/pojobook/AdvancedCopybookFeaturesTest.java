...
class AdvancedCopybookFeaturesTest {
    ...
    @Test
    void testRedefines() throws IOException {
    ...
    private static CopybookDefinition getDefinitionRedefines() throws IOException {
        String copybook = """
                   01  EMPLOYEE-RECORD.
                       05  EMP-ID              PIC 9(6).
                       05  EMP-DATA.
        ...
        return pojoBook.parseCopybookString(copybook);
    }

    @Test
    void testOccursFixed() throws IOException {
        String copybook = """
                   01  SALES-RECORD.
                       05  STORE-ID            PIC 9(4).
    ...
    @Test
    void testOccursDependingOn() throws IOException {
    ...
    private static CopybookDefinition getDefinitionOccursDependingOn() throws IOException {
        String copybook = """
                   01  ORDER-RECORD.
                       05  ORDER-ID            PIC 9(8).
    ...
    @Test
    void testOccursWithIndexedBy() throws IOException {
        String copybook = """
                   01  INVENTORY-RECORD.
    ...
    @Test
    void testOccursWithAscendingKey() throws IOException {
    ...
    private static CopybookDefinition getDefinitionOccursWithAscendingKey() throws IOException {
        String copybook = """
                   01  CUSTOMER-TABLE.
    ...
    @Test
    void testFiller() throws IOException {
        String copybook = """
                   01  FORMATTED-RECORD.
    ...
    @Test
    void testValueClause() throws IOException {
        String copybook = """
                   01  CONSTANT-RECORD.
    ...
    @Test
    void testJustifiedRight() throws IOException {
        String copybook = """
                   01  TEXT-RECORD.
    ...
    @Test
    void testBlankWhenZero() throws IOException {
        String copybook = """
                   01  DISPLAY-RECORD.
    ...
    @Test
    void testSynchronized() throws IOException {
        String copybook = """
                   01  ALIGNED-RECORD.
                       05  FIELD-1             PIC X(3).
    ...
    @Test
    void testComplexNestedStructureWithRedefines() throws IOException {
    ...
    private static CopybookDefinition getDefinitionComplexNestedStructureWithRedefines() throws IOException {
        String copybook = """
    ...
    @Test
    void testUsageVariations() throws IOException {
        ...
        assertEquals(CobolDataType.COMP, fieldComp.getType());
    ...
    private static CopybookDefinition getDefintiionUsageVariations() throws IOException {
        String copybook = """
                   01  USAGE-EXAMPLES.
