...
public class CopybookSerializationBenchmark {
    ...
    public void setup() throws Exception {
        ...
        // Convert to copybook binary format
    ...
    @Benchmark
    public boolean benchmarkAnnotationSerialization() throws Exception {
        byte[] ser = pojoBook.serialize(annotationPojo, CHARSET);
        assert Arrays.equals(ser, original);
        return true;
    }

    @Benchmark
    public boolean benchmarkJRecordSerialization() throws Exception {
        byte[] ser = copybookConverter.convertToCopybookData(jrecordPojo);
        assert Arrays.equals(ser, original);
        return true;
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CopybookSerializationBenchmark.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}
