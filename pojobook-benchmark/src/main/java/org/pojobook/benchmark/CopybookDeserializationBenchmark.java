...
public class CopybookDeserializationBenchmark {
    ...
    @Benchmark
    public org.pojobook.samples.annotation.SampleCbk benchmarkAnnotationDeserialization() throws Exception {
        return pojoBook.deserialize(copybookData, org.pojobook.samples.annotation.SampleCbk.class, CHARSET);
    }

    @Benchmark
    public LineSampleCbkPojo benchmarkJRecordDeserialization() throws Exception {
        return copybookConverter.convertToCopybookModel(copybookData);
    }

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(CopybookDeserializationBenchmark.class.getSimpleName())
                .build();
        new Runner(opt).run();
    }
}
