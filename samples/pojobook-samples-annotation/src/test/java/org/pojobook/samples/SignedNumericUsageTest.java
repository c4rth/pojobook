...
public class SignedNumericUsageTest {
    ...
    void testUsage() throws Exception {
        ...
        SignedNumeric deserialized = pojoBook.deserialize(cobolData, SignedNumeric.class, charset);
    ...
    void testDeserializeData() throws Exception {
        ...
        SignedNumeric deserialized = pojoBook.deserialize(cobolData, SignedNumeric.class, StandardCharsets.ISO_8859_1);
