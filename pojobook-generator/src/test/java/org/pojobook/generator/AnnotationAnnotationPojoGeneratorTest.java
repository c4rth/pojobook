...
class AnnotationAnnotationPojoGeneratorTest {
    ...
    @Test
    void testGeneratePojoWithOccursVariations() throws ParseException {
    ...
    @Test
    void testGeneratePojo() throws ParseException {
        String copybook = """
                   01  EMPLOYEE-RECORD.
    ...
    @Test
    void testGeneratePojo2() throws ParseException {
        String copybook = """
