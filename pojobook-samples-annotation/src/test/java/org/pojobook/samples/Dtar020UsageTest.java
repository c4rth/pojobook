...
import org.pojobook.samples.generated.Dtar020;
...
public class Dtar020UsageTest {
    ...
    void testSerializeAndDeserialize() throws Exception {
        ...
        Dtar020 deserialized = pojoBook.deserialize(cobolData, Dtar020.class, charset);
    ...
    private void check(int index, Dtar020 line) {
        ...
        assertEquals(new BigDecimal(expected[idx]).stripTrailingZeros(), line.getDtar020SalePrice());
    }
