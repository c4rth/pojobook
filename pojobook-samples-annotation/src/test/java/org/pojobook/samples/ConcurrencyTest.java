...
/**
 * Multithreaded concurrency tests to validate thread-safety of PojoBook
...
class ConcurrencyTest {
                ...
                executor.submit(() -> {
                    try {
                        ...
                        for (int i = 0; i < OPERATIONS_PER_THREAD; i++) {
                            ...
                            // Deserialize
                            CustomerRecord deserialized = pojoBook.deserialize(data, CustomerRecord.class, Charset.forName("CP1047"));
                ...
                executor.submit(() -> {
                    try {
                        ...
                        for (int i = 0; i < OPERATIONS_PER_THREAD; i++) {
                            ...
                            byte[] data = pojoBook.serialize(original, StandardCharsets.ISO_8859_1);
                            BankingTransaction deserialized = pojoBook.deserialize(data, BankingTransaction.class, StandardCharsets.ISO_8859_1);
        ...
        try (ExecutorService executor = Executors.newFixedThreadPool(NUM_THREADS)) {
            ...
            for (int i = 0; i < NUM_THREADS; i++) {
                futures.add(executor.submit(() -> {
                    startLatch.await();
                    return pojoBook.serialize(template, Charset.forName("CP1047"));
                }));
            }
    ...
    void testConcurrentDeserializationOfSameData() throws Exception {
        ...
        byte[] sharedData = pojoBook.serialize(original, Charset.forName("CP1047"));
                ...
                executor.submit(() -> {
                    try {
                        ...
                        for (int j = 0; j < OPERATIONS_PER_THREAD; j++) {
                            CustomerRecord deserialized = pojoBook.deserialize(sharedData, CustomerRecord.class, Charset.forName("CP1047"));
                ...
                executor.submit(() -> {
                    try {
                        ...
                        for (int i = 0; i < OPERATIONS_PER_THREAD; i++) {
                            ...
                            BankingTransaction deserialized = pojoBook.deserialize(data, BankingTransaction.class, charset);
    ...
    private void testEmployeeRecord(int id) throws Exception {
        ...
        byte[] data = pojoBook.serialize(original, StandardCharsets.ISO_8859_1);
        EmployeeRecord deserialized = pojoBook.deserialize(data, EmployeeRecord.class, StandardCharsets.ISO_8859_1);
