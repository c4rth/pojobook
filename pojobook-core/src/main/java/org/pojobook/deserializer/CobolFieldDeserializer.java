...
public class CobolFieldDeserializer {
    ...
    public static Short deserializeCompShort(byte[] data, int offset, int size) {
        return ByteBuffer.wrap(data, offset, size).getShort();
    }
    ...
    public static Integer deserializeCompInteger(byte[] data, int offset, int size) {
        if (size == 2) {
            return (int) ByteBuffer.wrap(data, offset, size).getShort();
        }
        return ByteBuffer.wrap(data, offset, size).getInt();
    }
    ...
    public static Long deserializeCompLong(byte[] data, int offset, int size) {
        if (size == 8) {
            return ByteBuffer.wrap(data, offset, size).getLong();
        }
        return (long) ByteBuffer.wrap(data, offset, size).getInt();
    }
    ...
    /**
     * Helper method to deserialize COMP-3 to BigInteger.
     */
    ...
    /**
     * Helper method to deserialize ZONED-DECIMAL to BigInteger.
     */
